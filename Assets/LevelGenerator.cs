...
public class LevelGenerator : MonoBehaviour
{
    ...
    IEnumerator SetExit()
    {
        ...
        int length = exits.Length - 1;
        int id = Random.Range(0, length + 1);
    ...
    void DrawMap()
    {
        foreach (Room room in rooms)
        {
            ...
            MapSprite mapper = Object.Instantiate(roomWhiteObj, drawPos, Quaternion.identity).GetComponent<MapSprite>();
